...
--
-- Dumping data for table `COEF_CONFIANCE`
--

DROP TABLE IF EXISTS `COEF_CONFIANCE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `COEF_CONFIANCE`(
  `COEF_CODE`    Int (3) NOT NULL ,
  `COEF_LIBELLE` Varchar (25) NOT NULL ,
  PRIMARY KEY (`COEF_CODE` )
)ENGINE=InnoDB;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `COEF_CONFIANCE` WRITE;
/*!40000 ALTER TABLE `COEF_CONFIANCE` DISABLE KEYS */;
INSERT INTO `COEF_CONFIANCE` VALUES 
	(1,'Aucune confiance'),
	(2,'Confiance extrêmement faible'),
	(3,'Confiance très faible'),
	(4,'Confiance faible'),
	(5,'Moyennement confiant'),
	(6,'Confiance assez bonne'),
	(7,'Confiance bonne'),
	(8,'Confiant'),
	(9,'Très confiant'),
	(10,'Totalement confiant');
/*!40000 ALTER TABLE `COEF_CONFIANCE` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `MOTIF` VALUES 
	(1,'Présentation des nouveautés'),
	(2,'Aucune visite récente');
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `MOT_CODE` Int (10) NOT NULL ,
  `COEF_CODE` Int (3) NOT NULL ,
  `EST_CONSULTE` Boolean NOT NULL DEFAULT FALSE,
...
INSERT INTO `RAPPORT_VISITE` VALUES 
	('n58', 1, 4, 'TEST', '2015-11-08', '2015-11-03', 1, 8, 0),
	('p49', 2, 7, 'TEST2', '2015-10-15', '2015-10-11', 1, 4, 0),
	('t60', 3, 9, 'TEST3', '2015-09-09', '2015-09-06', 1, 5, 0);
...
CREATE TABLE `VISITEUR` (
  ...
  `VIS_LOGIN` varchar(30) UNIQUE DEFAULT NULL,
...
INSERT INTO `VISITEUR` (VIS_MATRICULE, VIS_NOM, VIS_PRENOM, VIS_ADRESSE, VIS_CP, VIS_VILLE, VIS_DATEEMBAUCHE, VIS_LOGIN, SEC_CODE, LAB_CODE)
 VALUES 
	('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08','lvillechalane',NULL,'SW'),
	('a17','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19','dandre',NULL,'GY'),
	('a55','Bedos','Christian','1 rue Bénédictins','65000','TARBES','2007-09-07','cbedos',NULL,'GY'),
	('a93','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09','ltusseau',NULL,'SW'),
	('b13','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06','pbentot',NULL,'GY'),
	('b16','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06','lbioret',NULL,'SW'),
	('b19','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23','fbunisset',NULL,'GY'),
	('b25','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04','dbunisset',NULL,'SW'),
	('b28','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10','bcacheux',NULL,'GY'),
	('b34','Cadic','Eric','123 rue Caponière','41000','BLOIS','2012-06-03','ecadic','P','SW'),
	('b4','Charoze','Catherine','100 place Géants','33000','BORDEAUX','2009-05-07','ccharoze',NULL,'SW'),
	('b50','Clepkens','Christophe','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18','cclepkens',NULL,'SW'),
	('b59','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19','vcottin',NULL,'GY'),
	('c14','Daburon','François','13 rue Champs Elysées','6000','NICE','2012-01-20','fdaburon','S','SW'),
	('c3','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29','pde',NULL,'SW'),
	('c54','Debelle','Michel','181 rue Caponière','88000','EPINAL','2004-09-19','mdebelle',NULL,'SW'),
	('d13','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25','jdebelle',NULL,'SW'),
	('d51','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','mdebroise','E','GY'),
	('e22','Desmarquest','Nathalie','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18','ndesmarquest',NULL,'GY'),
	('e24','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','pdesnot','E','SW'),
	('e39','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18','ddudouit',NULL,'GY'),
	('e49','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16','cduncombe',NULL,'GY'),
	('e5','Enault-Pascreau','Céline','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','cenaultpascreau','S','GY'),
	('e52','Eynde','Valérie','3 rue Henri Moissan','76000','ROUEN','2012-09-16','veynde',NULL,'GY'),
	('f21','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16','jfinck',NULL,'SW'),
	('f39','Frémont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29','ffremont',NULL,'GY'),
	('f4','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29','agest',NULL,'GY'),
	('g19','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29','ggheysen',NULL,'SW'),
	('g30','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','ygirard','N','GY'),
	('g53','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25','lgombert',NULL,'GY'),
	('g7','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25','cguindon',NULL,'GY'),
	('h13','Guindon','François','44 rue Picotière','19000','TULLE','2012-05-25','fguindon',NULL,'SW'),
	('h30','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19','gigigabel',NULL,'SW'),
	('h35','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19','pjourdren',NULL,'GY'),
	('h40','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19','prjuttard',NULL,'GY'),
	('j45','Euré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','seuremorel','N','SW'),
	('j50','Landré','Philippe','4 avenue du Général Laperrine','59000','LILLE','2000-05-01','plandre',NULL,'GY'),
	('j8','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','hlangeard','P','GY'),
	('k4','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01','blanne',NULL,'SW'),
	('k53','Le','Noël','4 avenue Beauvert','68000','MULHOUSE','2000-05-01','nle',NULL,'SW'),
	('l14','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01','jle',NULL,'SW'),
	('l23','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23','sleclercq',NULL,'SW'),
	('l46','Lecornu','Jean-Bernard','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23','jblecornu',NULL,'GY'),
	('l56','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23','llecornu',NULL,'SW'),
	('m35','Lejard','Agnès','4 rue Anthoard','82000','MONTAUBAN','1998-11-23','alejard',NULL,'SW'),
	('m45','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23','plesaulnier',NULL,'SW'),
	('n42','Letessier','Stéphane','5 chemin de Capuche','27000','EVREUX','1998-11-23','sletessier',NULL,'GY'),
	('n58','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23','dloirat',NULL,'GY'),
	('n59','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21','tmaffezzoli',NULL,'SW'),
	('o26','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21','amancini',NULL,'GY'),
	('p32','Marcouiller','Gérard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21','gmarcouiller',NULL,'GY'),
	('p40','Michel','Jean-Claude','5 rue Gabriel Péri','61000','FLERS','2005-12-21','jcmichel','O','SW'),
	('p41','Montecot','Françoise','6 rue Paul Valéry','17000','SAINTES','2005-12-21','fmontecot',NULL,'GY'),
	('p42','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21','vnotini',NULL,'SW'),
	('p49','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21','donfroy',NULL,'GY'),
	('p6','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30','cpascreau',NULL,'SW'),
	('p7','Pernot','Claude-Noël','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02','cnpernot',NULL,'SW'),
	('p8','Perrier','Maître','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23','mperrier',NULL,'GY'),
	('q17','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07','jlpetit',NULL,'GY'),
	('r24','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','ppiquery','O','GY'),
	('r58','Quiquandon','Joëll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30','jquiquandon',NULL,'GY'),
	('s10','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05','jretailleau',NULL,'SW'),
	('s21','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09','pretailleau',NULL,'SW'),
	('t43','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03','msouron',NULL,'SW'),
	('t47','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29','ptiphagne',NULL,'SW'),
	('t55','Tréhet','Alain','7D chemin Barral','12000','RODEZ','1994-11-29','atrehet',NULL,'SW'),
	('t60','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29','jtusseau',NULL,'GY');
...
CREATE INDEX IDX_PRA_NUM ON RAPPORT_VISITE(PRA_NUM) ;

ALTER TABLE `OFFRIR` ADD CONSTRAINT  `FK_OFFRIR_RAPPORT_VISITE` FOREIGN KEY (`VIS_MATRICULE`, `RAP_NUM`)  REFERENCES `RAPPORT_VISITE`(`VIS_MATRICULE`, `RAP_NUM`)  ;
...
ALTER TABLE `RAPPORT_VISITE` ADD CONSTRAINT  `FK_RAPPORT_VISITE_MOT_CODE` FOREIGN KEY (`MOT_CODE`) REFERENCES `MOTIF`(`MOT_CODE`);
ALTER TABLE `RAPPORT_VISITE` ADD CONSTRAINT  `FK_RAPPORT_VISITE_COEF_CODE` FOREIGN KEY (`COEF_CODE`) REFERENCES `COEF_CONFIANCE`(`COEF_CODE`);
